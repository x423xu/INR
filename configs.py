...
parser.add_argument('--log_model', default=False, action='store_true', help='whether to log weights and grads of the model')

# parameters for GNR
parser.add_argument('--in_out_ratio', type=float, default=1, help='inner loop to outer loop ratio')
...
parser.add_argument('--WANDB', action='store_true', default=False, help='whether to use self.spec_args.WANDB to log')
parser.add_argument('--show_prog', action='store_true', default=False, help='whether to show progress bar')
parser.add_argument('--reload_weights', action='store_true', default=False, help='whether to reload weights')
parser.add_argument('--reload_warmup', type=int, default=0, help='reload epoch')
